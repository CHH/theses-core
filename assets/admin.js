...
(function() {
  var Post, PostList, exports;

  exports = window.theses || (window.theses = {});
  ...
  exports.QuickPostForm = React.createClass({
    ...
    render: function() {
      ...
      return R.form({
        ...
        className: "post-type"
      }, "Post something:", R.ul(null, (function() {
        var _ref, _results;
        _ref = this.navEntries;
        _results = [];
        for (id in _ref) {
          entry = _ref[id];
          _results.push(R.li({
            key: id,
            className: this.state.postType === id ? "active" : ""
          }, R.a({
            href: "#",
            onClick: this.setPostType.bind(this, id)
          }, R.i({
            className: "fa fa-" + entry.icon
          }), R.span(null, entry.label))));
        }
        return _results;
      }).call(this))), this.state.postType ? R.div({
        className: "fields " + this.state.postType
      }, (function() {
        ...
        className: "buttons"
      }, R.button(null, "Post"), R.a({
        onClick: this.setPostType.bind(this, void 0)
      }, "Nevermind"))) : void 0);
    }
  });
  ...
  exports.Post = Post = React.createClass({
    render: function() {
      ...
      return article(null, this.props.post.content);
    }
  });
  ...
  exports.CustomPropertyList = React.createClass({
    getInitialState: function() {
      var prop, props, value, _ref;
      if (this.props.properties) {
        console.log(this.props.properties);
        props = [];
        _ref = this.props.properties;
        for (prop in _ref) {
          value = _ref[prop];
          props.push({
            property: prop,
    ...
    render: function() {
      var R, i, prop;
      R = React.DOM;
      return R.div(null, R.ul(null, (function() {
        var _i, _len, _ref, _results,
          _this = this;
        _ref = this.state.properties;
        _results = [];
        for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
          ...
          _results.push(R.li({
            ...
            className: "property",
            name: "post[custom][" + i + "][property]",
            type: "text",
            value: prop.property,
            onChange: function(ev) {
              return _this.changePropertyName(ev, i);
            }
          }), R.input({
            placeholder: "Value",
            className: "value",
            name: "post[custom][" + i + "][value]",
            type: "text",
            value: prop.value,
            onChange: function(ev) {
              return _this.changePropertyValue(ev, i);
            }
          })));
        }
        return _results;
    ...
    changePropertyName: function(event, index) {
      var props;
      console.log(index);
    ...
    changePropertyValue: function(event, index) {
      var props;
      props = this.state.properties;
